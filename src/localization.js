...
const EN = {
  ...
  filters: {
    ...
    scrollFiltersBackward: "Scroll filters backward",
    scrollFiltersForward: "Scroll filters forward",
    pillar: "Pillar",
    phase: "Phase",
...
const MS = {
  ...
  filters: {
    ...
    scrollFiltersBackward: "Tatal penapis ke belakang",
    scrollFiltersForward: "Tatal penapis ke hadapan",
    pillar: "Teras",
    phase: "Fasa",
